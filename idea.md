...
* **Felaketleştirme:** "Bu sunum kötü geçti, ben başarısızım" (Küçük bir hatayı büyük bir başarısızlık olarak görme).
...
1.  **Metin Analizi:** Girdiyi parçalar ve bilişsel çarpıtma örüntülerini tanır.
2.  **Etiketleme:** Hangi düşünce hatasının yapıldığını tespit eder (Örn: Genelleme).
3.  **Yargılamasız Açıklama:** Asla "yanlış düşünüyorsun" demez; bunun yerine "Bu düşünce, sınırlı bir deneyimi genelleyerek geniş bir sonuca varıyor olabilir" şeklinde objektif bir geri bildirim verir.
4.  **Dengeli Alternatif:** Kullanıcıya durumun daha sağlıklı ve yapıcı bir versiyonunu sunar.

## 🔥 WOW Özelliği: "Mesajını Dönüştür"
Uygulamanın en vurucu noktası, negatif bir düşünceyi tek tıkla rasyonel bir cümleye çevirmesidir:
* **Girdi:** "Ben başarısızım."
* **Dönüşüm:** "Bu deneyim istediğim gibi gitmedi ama bu benim genel başarımı tanımlamaz."
...
---
*⚠️ **Not:** Bu bir terapi aracı değildir. Sadece düşünce farkındalığı sağlamak amacıyla tasarlanmıştır.*
